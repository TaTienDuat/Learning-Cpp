...
void test4()
{
     ...
     std::advance(it, -4); // point the 100
     std::cout << *it << std::endl;

     l.erase(it); // remove the 100  -iterator become invaid
     display(l);
}
...
void test5()
{
     ...
     // Insert Duat before Moe
     auto it = std::find(stooges.begin(), stooges.end(), Person("Moe", 28));
     if (it != stooges.end())
     {
     }
