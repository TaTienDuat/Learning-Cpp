...
bool is_palindrome(const std::string& s)
{
     ...
     // add all the string characters that are alpha to the back of the deque of the uppercase
     for (char c : s)
          if (std::isalpha(c))
     ...
     char c1{};
     char c2{};
     // while are more than 1 characters in he deque
     ...
     // if you complete the loop the the string must be a palindrome so return true
