// Stream mainipulatrors - Boolean
// boolalpha and noboolalapha
#include <iostream>
...
int main()
{
     ...
     std::cout << "noboolalpha - default (20 == 10): " << (10 == 20) << std::endl;

     // Set to true/false formating
     std::cout << std::boolalpha; // change to frue or false
     std::cout << "noboolalpha - default (10 == 10): " << (10 == 10) << std::endl;
     std::cout << "noboolalpha - default (20 == 10): " << (10 == 20) << std::endl;
